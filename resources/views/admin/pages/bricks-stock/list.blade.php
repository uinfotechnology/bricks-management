            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Bricks Stock List</h5>
                        <div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table striped-table mb-0 bricks-stock-list-table">
                                <thead>
                                    <tr>
                                        <th scope="col">SI</th>
...
@push('js')
    ...
    <script>
        var BricksStockList = "{{ route('admin.bricks_stock.BricksStockList') }}";
    </script>
