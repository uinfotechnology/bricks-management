            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Labour List</h5>
                        <div>
                            <a href="{{ route('admin.labour.createLabourView') }}" class="btn btn-sm btn-primary">Create
                                New </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table striped-table mb-0 labour-table">
                                <thead>
                                    <tr>
                                        <th scope="col">SI</th>
                                        ...
                                        <th scope="col">Rate Per Thousand</th>
...
@push('js')
    ...
    <script>
        var labourList = "{{ route('admin.labour.labourList') }}";
    </script>
