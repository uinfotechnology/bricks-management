            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Labour Type List</h5>
                        <div>
                            <a href="{{ route('admin.labour_type.labourTypeView') }}" class="btn btn-sm btn-primary">Create
                                New </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table striped-table mb-0 labour-type-table">
                                <thead>
                                    <tr>
                                        <th scope="col">SI</th>
...
@push('js')
    ...
    <script>
        var labourTypeList = "{{ route('admin.labour_type.labourTypeList') }}";
    </script>
