            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Labour Payment List</h5>
                        <div>
                            <a href="{{ route('admin.labourPayment.createLabourPaymentView') }}"
                                class="btn btn-sm btn-primary">Create New </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table striped-table mb-0 labour-payment-table">
                                <thead>
                                    <tr>
                                        <th scope="col">SI</th>
...
@push('js')
    ...
    <script>
        var labourPaymentList = "{{ route('admin.labourPayment.labourPaymentList') }}";
    </script>
