                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row gy-3 needs-validation" method="POST"
                            action="{{ route('admin.account.updateAccount', Crypt::encrypt($account->id)) }}" novalidate>
                                ...
                                <select name="product_id" class="form-control" required>
                                    ...
                                    @foreach ($product as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $account->product_id == $item->id ? 'selected' : '' }}>
                                            {{ $item->product_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="party_name" class="form-control" placeholder="Enter Party Name"
                                    value="{{ old('party_name', $account->party_name) }}" required>
                                @error('party_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="contact_person" class="form-control"
                                    ...
                                    value="{{ old('contact_person', $account->contact_person) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mobile_number" class="form-control"
                                    ...
                                    value="{{ old('mobile_number', $account->mobile_number) }}" maxlength="10" required>
                                @error('mobile_number')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" name="secondary_mobile_number" class="form-control"
                                    ...
                                    value="{{ old('secondary_mobile_number', $account->secondary_mobile_number) }}"
                                    maxlength="10">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="gst_number" class="form-control" placeholder="Enter GST Number"
                                    value="{{ old('gst_number', $account->gst_number) }}" maxlength="15">
                                @error('gst_number')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="pan_number" class="form-control" placeholder="Enter PAN Number"
                                    value="{{ old('pan_number', $account->pan_number) }}" maxlength="10">
                                @error('pan_number')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="ifsc_code" class="form-control"
                                    placeholder="Enter IFSC Code" value="{{ old('ifsc_code', $account->ifsc_code) }}">
                                @error('ifsc_code')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date" class="form-control"
                                        value="{{ old('date', \Carbon\Carbon::parse($account->date)->format('Y-m-d')) }}">
                                    @error('date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="remarks" class="form-control" placeholder="Enter Remarks"
                                    value="{{ old('remarks', $account->remarks) }}">
                                @error('remarks')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
