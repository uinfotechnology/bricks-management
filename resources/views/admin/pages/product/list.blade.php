            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('admin.product.createProductView') }}" class="btn btn-sm btn-primary">Create
                                New </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table striped-table mb-0 product-table">
                                <thead>
                                    <tr>
                                        <th scope="col">SI</th>
...
@push('js')
    ...
    <script>
        var productList = "{{ route('admin.product.productList') }}";
    </script>
