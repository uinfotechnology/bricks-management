    ...
    <div class="dashboard-main-body">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Create Bricks Type Category</h5>
                    </div>
                    <div class="card-body">
                        <form class="row gy-3 needs-validation" method="POST"
                            action="{{ route('admin.bricks_type_category.storeBricksTypeCategory') }}" novalidate>
                            @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="bricks_type_category_name" class="form-control"
                                    placeholder="Enter Bricks Type Category" value="{{ old('bricks_type_category_name') }}" required>
        ...
        <div class="row gy-4 mt-1">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Bricks Type Category List</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table striped-table mb-0 bricks-type-category-table">
                                <thead>
                                    <tr>
                                        <th scope="col">SI</th>
...
@push('js')
    ...
    <script>
        var bricksTypeCategoryList = "{{ route('admin.bricks_type_category.bricksTypeCategoryList') }}";
    </script>
