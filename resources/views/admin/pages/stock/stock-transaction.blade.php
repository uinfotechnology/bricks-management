            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Stock Transaction</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table striped-table mb-0 stock-transaction-table">
                                <thead>
                                    <tr>
                                        <th scope="col">SI</th>
...
@push('js')
    ...
    <script>
        var stockTransactionList = "{{ route('admin.stock.stockTransactionList') }}";
    </script>
